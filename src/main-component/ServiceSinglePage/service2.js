...
const ServiceSinglePage2 = () => {
    ...
    return (
        <>
         <SEO title="HR Consultancy Services in Kerala | Befirst HR & Management Consultancy" 
                ...
                />
            <Navbar2 />
            <PageTitle pageTitle={serviceData.title} pagesub={'Services'} serviceTitle={serviceData.title} />
            <ServiceSingleSection service={serviceData} />
            <Footer />
            <Scrollbar />
        </>
    );
