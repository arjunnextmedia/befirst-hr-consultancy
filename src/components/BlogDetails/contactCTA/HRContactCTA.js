...
import { Phone, Mail, Globe, Building2, Users, Briefcase, ArrowRight } from 'lucide-react';
          ...
          <div className="col-lg-6 mb-3 mb-lg-0">
            <div className="text-white">
              <div className="mb-3 mb-md-4">
                <h2 className="mb-2 mb-md-3 fw-bold" style={{
                  color:'whitesmoke', 
                  fontWeight:'bold',
                ...
                <p className="mb-0 opacity-75 lh-base" style={{
                  color:'lightcyan',
                  fontSize: 'clamp(0.95rem, 2vw, 1.1rem)'
                }}>
                  Transform your workplace culture and attract top talent with Kerala's most trusted HR consultancy
                </p>
              </div>
              
              <div className="row g-3 mt-2">
                <div className="col-sm-6">
                  <div className="d-flex align-items-center bg-opacity-10 rounded-3 p-3" style={{backgroundColor:'#4865F1'}}>
                    <Users size={20} className="me-2 me-md-3 text-white flex-shrink-0" />
                    <div>
                      <div className="fw-semibold small">Expert Team</div>
                      <small className="opacity-75" style={{fontSize: '0.75rem'}}>Industry Veterans</small>
                    </div>
                  </div>
                </div>
                <div className="col-sm-6">
                  <div className="d-flex align-items-center bg-opacity-10 rounded-3 p-3" style={{backgroundColor:'#4865F1'}}>
                    <Briefcase size={20} className="me-2 me-md-3 text-white flex-shrink-0" />
                    <div>
                      <div className="fw-semibold small">Career Growth</div>
                      <small className="opacity-75" style={{fontSize: '0.75rem'}}>Exponential Progress</small>
                    </div>
                  </div>
                </div>
              </div>
