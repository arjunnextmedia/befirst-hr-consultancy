                    ...
                    <div className="posts">
                        <div className="post">
                            ...
                            <div className="details">
                                <h4><Link onClick={ClickHandler} to="/blogs/blog1/blog-details">How SMEs Can Build a Strong Employer Brand in Kerala</Link></h4>
                        ...
                        {/* <div className="post">
                            ...
                            <div className="details">
                                <h4><Link onClick={ClickHandler} to="/blogs/blog5/blog-details">The Complete Guide to HR Compliance in Kerala</Link></h4>
                                <span className="date">12 Apr 2021 </span>
                            </div>
                        </div> */}
                        <div className="post">
