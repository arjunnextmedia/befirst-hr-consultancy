...
class ContactForm extends Component {
    ...
    validateForm = () => {
        const { name, email, subject, lastname, events, notes } = this.state;
        const error = {};
        let isValid = true;
...
//     }
    ...
    submitHandler = (e) => {
        ...
        const whatsappNumber = "9947695010";
    ...
    render() {
        const { name, email, subject, lastname, notes, error, isSubmitting } = this.state;
